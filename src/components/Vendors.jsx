...
// // /**
// //  * Single-file Vendor management page.
// //  * - Table view (exact layout + colors approximated with Bootstrap).
// //  * - Location column added beside Email.
// //  * - Search filters by name, vendor name, email, phone, services, location, GST.
// //  * - Actions: View Orders, Edit, Activate/Deactivate, Approve/Disapprove
// //  * - Modals implemented using simple conditional rendering and Bootstrap classes.
// //  *
// //  * NOTE: This is static-data driven and UI-focused per your request.
// //  */
...
// //     gst: "xhhhnd",
// //     status: "Approved", // or "Pending Payment", "Deactivated" etc.
// //     approved: true,
// //     location: "Visakhapatnam, Andhra Pradesh",
// //     services: ["Grocery", "Electronics"],
// //     address: "na",
// //     orders: [], // empty to match screenshot which shows "No Orders Found"
// //   },
// //   {
// //     id: 5,
// //     firstName: "vendor",
...
// //   const [showOrdersFor, setShowOrdersFor] = useState(null); // vendor object OR null
// //   const [showEditModal, setShowEditModal] = useState(false);
// //   const [showAddModal, setShowAddModal] = useState(false);
// //   const [approveFlowFor, setApproveFlowFor] = useState(null); // vendor id when approve/disapprove options shown
// //   const [editingVendor, setEditingVendor] = useState(null);

// //   // Filtering logic for search bar: name, vendorName, emails, phone, services, location, gst
...
// //     setEditingVendor({ ...vendor }); // shallow copy
...
// //       {showOrdersFor && (
// //         <div className="mb-3">
// //           <button className="btn btn-link p-0" onClick={backToList} style={{ color: "#b61d23", textDecoration: "none" }}>
...
// //           <h2 style={{ color: "#b61d23", fontWeight: 700 }}>Vendors</h2>
// //           <div className="d-flex">
// //             <div className="input-group me-2" style={{ minWidth: 350 }}>
// //               <input
// //                 type="text"
...
// //               />
// //               <button className="btn" style={{ background: "#f7c700", border: "1px solid #f7c700" }}>
// //                 <FaSearch />
// //               </button>
// //             </div>
// //             <button className="btn" style={{ background: "#c21e26", color: "#fff", borderRadius: 6 }} onClick={openAdd}>
...
// //       {showOrdersFor ? (
// //         <div>
// //           <h2 style={{ color: "#b61d23", fontWeight: 700, marginBottom: 20 }}>Vendor Orders</h2>
...
// //                 const statStyle = { fontSize: 28, fontWeight: 700, marginBottom: 6 };
// //                 const labelStyle = { fontSize: 14, color: "#777" };
// //                 return (
// //                   <>
// //                     <div style={{ flex: 1 }}>
...
// //                     </div>
// //                     <div style={{ width: 1, background: "#eee", margin: "0 20px" }} />
// //                     <div style={{ flex: 1 }}>
// //                       <div style={{ ...statStyle, color: "#2f9e4b" }}>{delivered}</div>
// //                       <div style={labelStyle}>Delivered</div>
// //                     </div>
// //                     <div style={{ width: 1, background: "#eee", margin: "0 20px" }} />
// //                     <div style={{ flex: 1 }}>
// //                       <div style={{ ...statStyle, color: "#f1a21a" }}>{inprogress}</div>
// //                       <div style={labelStyle}>In Progress</div>
// //                     </div>
// //                     <div style={{ width: 1, background: "#eee", margin: "0 20px" }} />
// //                     <div style={{ flex: 1 }}>
// //                       <div style={{ ...statStyle, color: "#d33" }}>{cancelled}</div>
// //                       <div style={labelStyle}>Cancelled/Rejected</div>
// //                     </div>
// //                   </>
// //                 );
// //               })()}
...
// //           {/* Orders List */}
// //           <div className="card">
// //             <div className="card-header" style={{ background: "#b61d23", color: "#fff", fontWeight: 700 }}>
// //               Orders List
// //             </div>
// //             <div className="card-body" style={{ minHeight: 240 }}>
// //               {showOrdersFor.orders.length === 0 ? (
// //                 <div className="text-center" style={{ padding: "50px 0" }}>
// //                   <div style={{ fontSize: 48, color: "#777" }}>📦</div>
// //                   <h5 style={{ marginTop: 20, color: "#666" }}>No Orders Found</h5>
// //                   <div style={{ color: "#999" }}>This vendor doesn't have any orders yet.</div>
// //                 </div>
// //               ) : (
...
// //               <div className="table-responsive">
// //                 <table className="table table-striped mb-0 align-middle text-center" style={{ minWidth: 1100 }}>
// //                   <thead style={{ background: "maroon", color: "white" }}>
// //                     <tr>
// //                       <th style={{ width: 80 }}>Vendor ID</th>
// //                       <th style={{ width: 200 }}>Name</th>
// //                       <th style={{ width: 180 }}>Vendor Name</th>
// //                       <th style={{ width: 150 }}>Phone Number</th>
// //                       <th style={{ width: 220 }}>Email</th>
// //                       <th style={{ width: 200 }}>Location</th>
// //                       <th style={{ width: 140 }}>GST Number</th>
...
// //                               className="btn"
// //                               title="View Orders"
// //                               style={{ background: "#29c3d5", color: "#fff", borderRadius: 6 }}
...
// //                               className="btn"
// //                               title="Edit Vendor"
// //                               style={{ background: "#ffbf00", color: "#fff", borderRadius: 6 }}
// //                               onClick={() => openEdit(v)}
// //                             >
// //                               <FaEdit />
// //                             </button>
...
// //                             <button
// //                               className="btn"
// //                               title={v.status === "Deactivated" ? "Activate Vendor" : "Deactivate Vendor"}
// //                               style={{ background: "#ddd", color: "#333", borderRadius: 6 }}
// //                               onClick={() => toggleActive(v.id)}
// //                             >
// //                               {v.status === "Deactivated" ? <FaToggleOff /> : <FaToggleOn />}
// //                             </button>
...
// //                                 style={{ background: "#c9c9c9", color: "#fff", borderRadius: 6 }}
...
// //                           {/* Show details expanded when this vendor matches the query exactly or when user clicks */}
// //                         </td>
// //                       </tr>
// //                     ))}
...
// //                 <h5 className="modal-title" style={{ color: "#b61d23", fontWeight: 700 }}>
// //                   Edit Vendor
// //                 </h5>
...
// //                   Cancel
// //                 </button>
// //                 <button className="btn" style={{ background: "#ff9b00", color: "#fff" }} onClick={saveEdit}>
// //                   Update
// //                 </button>
// //               </div>
// //             </div>
...
//                   </div>
//                   <div className="col-md-6 mb-2">
//                     <strong>Services:</strong> {searchResult.services.join(", ")}
//                   </div>
//                   <div className="col-md-6 mb-2">
...
//       {showOrdersFor && (
//         <div>
//           <h3 className="text-danger fw-bold mb-4">Vendor Orders</h3>
